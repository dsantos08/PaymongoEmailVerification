...
public class CheckBox extends Browser {
	...
	public boolean isEnabled() {
		element = Browser.findElement(by);
		if (element == null) {
			Log.testStep("FAILED", name + " CheckBox is NOT enabled", name + " Checkbox is enabled");
			return false;
		} else {
	...
	public boolean isDisabled() {
		element = Browser.findElement(by);
		if (element == null) {
			Log.testStep("PASSED", name + " CheckBox is NOT enabled", name + " Checkbox NOT enabled");
			return true;
		} else {
			Log.testStep("FAILED", name + " CheckBox is enabled", name + " Checkbox is NOT enabled");
			return false;
		}

	}

	public void verifyUneditable(){
		element = Browser.findElement(by);
	...
	public void verifyTicked(){
		...
		if (element.isSelected()){
			...
			Log.testStep("FAILED", name + " CheckBox is NOT ticked", name + " CheckBox is ticked");
		}
	}

	public void verifyUnticked(){
		element = Browser.findElement(by);
		if (element.isSelected()){
			Log.testStep("FAILED", name + " CheckBox is ticked", name + " CheckBox is NOT ticked");
		} else {
			Log.testStep("PASSED", name + " CheckBox is NOT ticked", name + " CheckBox is NOT ticked");
		}
	}
